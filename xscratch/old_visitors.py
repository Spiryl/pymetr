...
class SubsystemVisitor(ast.NodeVisitor):
    ...
    def visit_Assign(self, node):
        ...
        if isinstance(node.value, ast.Call) and hasattr(node.value.func, 'id'):
            ...
            if prop_func_id in ['ValueProperty', 'SelectProperty', 'switch_property']:
    ...
    def parse_property_details(self, call_node, prop_func_id):
        ...
        Args:
            ...
            prop_func_id (str): The identified type of property (e.g., 'ValueProperty').
        ...
        elif prop_func_id in ['switch_property', 'DataProperty']:
...
if __name__ == "__main__":
    ...
    def format_property_summary(prop):
        ...
        elif prop['type'] in ['ValueProperty', 'int', 'float']:
