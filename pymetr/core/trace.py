...
class Trace:
    def __init__(self, data, x_data=None, z_data=None, label=None, color=None, mode=None, visible=True, line_thickness=1.0, line_style='Solid'):
        ...
        Args:
            ...
            data (list or np.array): Primary data points for the trace.
            x_data (list or np.array, optional): X-axis values if different from default range(len(data)).
    ...
    def update_data(self, data, x_data=None, z_data=None):
