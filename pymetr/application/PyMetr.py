...
class DynamicInstrumentGUI(QMainWindow):
    ...
    def connect_signals(self):
        ...
        self.trace_manager.traceDataUpdated.connect(self.trace_plot.update_trace_data) # update_trace_data
    ...
    def add_instrument_button_clicked(self):
        ...
        if dialog.exec() == QDialog.Accepted:
            ...
            if instrument:
                ...
                instrument_panel.continuous_mode_changed.connect(self.trace_manager.set_continuous_mode)
                ...
                instrument_panel.continuous_mode_changed.connect(instrument_instance.set_continuous_mode)
